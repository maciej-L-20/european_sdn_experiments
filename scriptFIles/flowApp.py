...
#TODO: 3.1 podaje je w formie do wysłania onosowi
#TODO: 3.2 aktualizacja grafu
...
def bw_dijkstra(graph, start):
    ...
    priority_queue = [(float('infinity'), start)]
...
def delay_dijkstra(graph, start):
    ...
    while priority_queue:
        ...
        # Iteracja po sąsiadach aktualnego wierzchołka
        for neighbor, _ , weight in graph[current_vertex]:
...
shortest_paths = bw_dijkstra(graph, start_vertex)
